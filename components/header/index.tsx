    ...
    <header className='w-full h-[80px] bg-primary'>
      <div className='container h-full w-full mx-auto'>
        <div className='h-full w-full flex items-center justify-between relative'>
          ...
          <Link href='/'>
            <Image src="/logo.svg" alt="Logo Jasur Tagaev Portfolio - Oncologist" width={200} height={60} className='h-[60px]' />
          </Link>
          <div>
            <button onClick={handleMenuOpen} className='text-white text-2xl cursor-pointer'>
              <HiOutlineMenu />
            </button>
