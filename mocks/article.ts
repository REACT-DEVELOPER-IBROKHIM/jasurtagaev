    ...
    structure: [
      ...
      },
      {
        ...
        elements: [
          {
            elementType: "image",
            content: "/article-images/scc/image-1.jpg",
          },
          {
            elementType: "image",
            content: "/article-images/scc/image-2.jpg",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        content: {
              ...
              elements: [
                {
                  ...
                  content: {
                    en: [
                      "Lesion Characteristics: SCC typically appears as a firm, red nodule or a scaly, crusted lesion. It may start as a rough, thickened patch of skin or a wart-like growth that becomes more prominent over time.",
                      "Color: The lesion may be flesh-colored, pink, red, or have a brown or gray hue, especially if it's associated with previous sun damage.",
                      "Texture: The surface of the lesion can be scaly, crusted, or ulcerated. Sometimes, it may bleed or become tender.",
                      "Size: SCC lesions may range from small to several centimeters in size and may grow rapidly.",
                    ],
                  },
                },
              ],
              ...
              elements: [
                {
                  ...
                  content: {
                    en: [
                      "Sun-Exposed Areas: SCC is most often found on areas of the skin that have been frequently exposed to the sun, such as the face, ears, neck, scalp, hands, forearms, shoulders, back, and lips. It can also occur in areas that are not typically sun-exposed, like the genitals, inside the mouth, and on mucous membranes (especially in those with compromised immune systems).",
                      "Chronic Wounds: SCC can also arise from chronic wounds, burn scars, or areas of skin irritation that have been exposed to repeated trauma or infection.",
                    ],
                  },
                },
              ],
              ...
              elements: [
                {
                  ...
                  content: {
                    en: [
                      "Sun Exposure: The most significant risk factor for developing SCC is exposure to ultraviolet (UV) radiation from the sun or tanning beds. Long-term, repeated exposure to UV rays damages the skin cells and increases the likelihood of cancerous changes.",
                      "Fair Skin: Individuals with fair skin, blonde or red hair, and blue or green eyes are more prone to developing SCC because they are more sensitive to sun damage.",
                      "Age: SCC is more common in older adults, particularly those aged 50 years or older, as the cumulative sun exposure over time increases the risk.",
                      "Immunosuppression: People with weakened immune systems, such as those undergoing organ transplantation or HIV/AIDS, are at a higher risk. Immunosuppressive medications can also increase the likelihood of SCC.",
                      "Previous Skin Cancer: A history of basal cell carcinoma or other skin cancers increases the risk of developing SCC.",
                      "Human Papillomavirus (HPV): Certain strains of HPV can increase the risk of developing SCC, particularly in mucosal regions like the mouth, throat, or genital area.",
                      "Chronic Skin Conditions: Conditions like actinic keratosis (AK), a precancerous lesion caused by sun damage, can increase the likelihood of developing SCC. Additionally, scar tissue from burns or chronic inflammation is a risk factor.",
                    ],
                  },
                },
              ],
              ...
              elements: [
                {
                  ...
                  content: {
                    en: [
                      "Changes in Skin Lesions: SCC may appear as a growing, scaly, or crusted bump that doesn’t heal over time. It may bleed, crust over, and then reopen.",
                      "Pain or Tenderness: The tumor can become painful as it grows or ulcerates, and it may cause bleeding or itching.",
                      "Ulceration: In some cases, SCC lesions may become ulcerated and have a central crater with a firm border.",
                      "Swelling: If the cancer spreads to nearby lymph nodes, swelling may be noted.",
                    ],
                  },
                },
              ],
              ...
              elements: [
                {
                  ...
                  content: {
                    en: [
                      "Clinical Examination: An oncodermatologist or healthcare provider will examine the suspicious lesion, looking for features of SCC such as scaliness, firmness, irregular borders, and possible bleeding.",
                      "Skin Biopsy: A skin biopsy is the most reliable way to confirm the diagnosis. A small sample of the suspicious lesion is taken and examined under a microscope for signs of cancerous changes in the squamous cells.",
                      "Imaging: If the tumor is suspected to have spread beyond the skin, imaging tests such as X-rays, CT scans, or MRI may be used to check for lymph node involvement or metastasis to other organs.",
                    ],
                  },
                },
              ],
              ...
              elements: [
                {
                  ...
                  content: {
                    en: [
                      "Stage 0 (Carcinoma in Situ): The cancer is confined to the epidermis (the outermost layer of skin) and has not spread deeper.",
                      "Stage I-III: The cancer has grown deeper into the skin and may have spread to nearby lymph nodes or other tissues, but has not yet spread to distant organs.",
              ...
              elements: [
                {
                  ...
                  content: {
                    en: [
                      "Surgical Excision: Wide Local Excision (WLE): The most common treatment for SCC involves surgically removing the tumor along with a margin of healthy tissue to ensure clear edges and reduce the risk of recurrence.",
                      "Mohs Micrographic Surgery: This technique is particularly useful for SCCs located on areas with a high risk of recurrence or in cosmetically sensitive areas like the face. The tumor is removed layer by layer, with each layer examined under a microscope to ensure that all cancerous cells have been excised.",
                      "Radiation Therapy: Radiation may be used in cases where surgery is not feasible or if the tumor is inoperable (for example, in high-risk locations or for advanced disease). It can also be used post-surgery to treat remaining cancerous cells and reduce the risk of recurrence.",
                      "Cryotherapy: Cryotherapy (freezing the tumor) may be an option for small, superficial SCCs, especially those found on the surface of the skin.",
                      "Topical Treatments: Topical chemotherapy (e.g., 5-fluorouracil) or immune-modulating treatments (such as imiquimod) may be used for superficial SCC or precancerous lesions like actinic keratosis.",
                      "Chemotherapy: For advanced or metastatic SCC, chemotherapy may be employed, though it is typically reserved for cases where the cancer has spread to distant areas and is not amenable to surgery or radiation.",
                      "Immunotherapy: Immunotherapy agents, like checkpoint inhibitors (e.g., pembrolizumab or nivolumab), may be used for advanced SCC that has spread to other parts of the body. These drugs work by stimulating the body's immune system to recognize and fight the cancer.",
                    ],
                  },
                },
              ],
              ...
              elements: [
                {
                  ...
                  content: {
                    en: [
                      "Prognosis for SCC depends on factors such as the size, location, and depth of the tumor, as well as whether it has spread to lymph nodes or distant organs.",
                      "Localized SCC (confined to the skin) has a high cure rate, especially if treated early. The 5-year survival rate for localized SCC is generally high.",
                      "Metastatic SCC, where the cancer has spread to distant organs, is more difficult to treat and has a poorer prognosis.",
                    ],
                  },
                },
              ],
              ...
              elements: [
                {
                  ...
                  content: {
                    en: [
                      "Sun Protection: Protecting your skin from UV radiation is the most effective way to prevent SCC. This includes wearing broad-spectrum sunscreen with SPF 30 or higher, wearing protective clothing (e.g., hats, sunglasses), and seeking shade during peak sun hours.",
                      "Avoid Tanning Beds: Tanning beds are a known risk factor for skin cancer and should be avoided to reduce the risk of developing SCC and other skin cancers.",
                      "Regular Skin Checks: Routine skin self-exams and regular visits to an oncodermatologist are essential, especially for people at higher risk (those with a history of sunburns, fair skin, or other skin cancers). Early detection of SCC can improve treatment outcomes.",
                    ],
                  },
                },
              ],
          ...
          ru: [
              ...
              elements: [
                {
                  ...
                  content: {
                    ru: [
                      "Характеристика новообразований: ПКР обычно проявляется в виде плотного красного узелка или чешуйчатого, покрытого коркой поражения. Может начинаться как шероховатое, утолщённое пятно или бородавчатое разрастание, которое со временем становится заметнее.",
                      "Цвет: Поражение может быть телесного, розового, красного, коричневого или серого оттенка, особенно при наличии признаков повреждения от солнца.",
                      "Текстура: Поверхность может быть чешуйчатой, покрытой коркой или изъязвлённой. Иногда может кровоточить или быть болезненной.",
                      "Размер: Размер новообразования варьируется от небольшого до нескольких сантиметров. Часто наблюдается быстрый рост.",
                    ],
                  },
                },
              ],
            ...
            {
              text: "Обычные локализации:",
              elements: [
                {
                  elementType: "list",
                  content: {
                    ru: [
                      "Участки, подверженные воздействию солнца: Наиболее часто ПКР встречается на лице, ушах, шее, коже головы, руках, предплечьях, плечах, спине и губах. Может также возникать в зонах, обычно не подверженных воздействию солнца, таких как половые органы, ротовая полость и слизистые оболочки (особенно у людей с ослабленным иммунитетом).",
                      "Хронические раны: ПКР может развиться на месте хронических ран, ожоговых рубцов или участков кожи, подвергавшихся длительному раздражению или инфекциям.",
                    ],
                  },
                },
              ],
              ...
              elements: [
                {
                  ...
                  content: {
                    ru: [
                      "Воздействие ультрафиолета: Основной фактор риска — это длительное и повторяющееся воздействие УФ-излучения от солнца или соляриев.",
                      "Светлая кожа: Люди со светлой кожей, светлыми или рыжими волосами и голубыми или зелёными глазами более подвержены риску развития ПКР.",
                      "Возраст: Чаще встречается у пожилых людей (старше 50 лет).",
                      "Иммуносупрессия: Люди с ослабленной иммунной системой (например, после трансплантации органов или при ВИЧ/СПИДе) имеют повышенный риск.",
                      "Предшествующие случаи рака кожи: Наличие в анамнезе других видов рака кожи, таких как базальноклеточная карцинома, увеличивает риск развития ПКР.",
                      "Инфекция ВПЧ: Некоторые штаммы вируса папилломы человека (ВПЧ) увеличивают риск ПКР, особенно на слизистых оболочках.",
                      "Хронические кожные заболевания: Предраковые состояния, такие как актинический кератоз, и рубцовая ткань от ожогов или хронических воспалений — также факторы риска.",
                    ],
                  },
                },
              ],
              ...
              elements: [
                {
                  ...
                  content: {
                    ru: [
                      "Изменения кожи: Растущий, чешуйчатый или покрытый коркой узелок, который не заживает. Может кровоточить или зудеть.",
                      "Боль или чувствительность: По мере роста или изъязвления новообразование может вызывать боль.",
                      "Изъязвление: Иногда развивается изъязвление с центральным кратером и плотными краями.",
                      "Отёк: При распространении на лимфоузлы может наблюдаться их увеличение.",
                    ],
                  },
                },
              ],
              ...
              elements: [
                {
                  ...
                  content: {
                    ru: [
                      "Клинический осмотр: Онкодерматолог исследует подозрительное образование, обращая внимание на чешуйчатость, плотность, неровные границы и возможное кровотечение.",
                      "Биопсия кожи: Основной метод подтверждения диагноза — взятие образца ткани для микроскопического анализа.",
                      "Визуализация: При подозрении на метастазы может потребоваться КТ, МРТ или рентген.",
                    ],
                  },
                },
              ],
              ...
              elements: [
                {
                  ...
                  content: {
                    ru: [
                      "Стадия 0 (рак in situ): Опухоль ограничена эпидермисом.",
                      "Стадии I–III: Рак проникает глубже в кожу и может затрагивать лимфоузлы, но не распространяется на отдалённые органы.",
                      "Стадия IV: Метастазирование в отдалённые органы (печень, лёгкие, кости и др.).",
                    ],
                  },
                },
              ],
              ...
              elements: [
                {
                  ...
                  content: {
                    ru: [
                      "Хирургическое удаление: Широкое иссечение — удаление опухоли с прилегающей здоровой тканью.",
                      "Микрографическая хирургия по Моосу: Применяется на участках с высоким риском рецидива или в косметически значимых зонах.",
                      "Лучевая терапия: Применяется при невозможности хирургического лечения или после операции для уничтожения оставшихся раковых клеток.",
                      "Криотерапия: Подходит для поверхностных форм ПКР.",
                      "Местное лечение: Химиотерапевтические или иммуномодулирующие мази (например, 5-фторурацил или имиквимод) могут использоваться для поверхностных форм ПКР.",
                      "Химиотерапия: Применяется при запущенных формах, если другие методы невозможны.",
                      "Иммунотерапия: Ингибиторы контрольных точек (например, пембролизумаб или ниволумаб) стимулируют иммунную систему распознавать и атаковать опухоль.",
                    ],
                  },
                },
              ],
              ...
              elements: [
                {
                  ...
                  content: {
                    ru: [
                      "Прогноз зависит от размера, глубины, локализации опухоли и степени её распространения.",
                      "При раннем выявлении и локализованной форме прогноз благоприятный.",
                      "При метастазах выживаемость значительно снижается.",
                    ],
                  },
                },
              ],
              ...
              elements: [
                {
                  ...
                  content: {
                    ru: [
                      "Защита от солнца: Использование солнцезащитного крема (SPF 30+), защитной одежды, избегание солнца в часы пик.",
                      "Отказ от соляриев: Уменьшает риск развития ПКР и других видов рака кожи.",
                      "Регулярные осмотры: Самообследования кожи и визиты к онкодерматологу особенно важны для людей с высоким риском.",
                    ],
                  },
                },
              ],
              ...
              elements: [
                {
                  ...
                  content: {
                    kr: [
                      "Янги ҳосилалар тавсифи: ЯҲК одатда зич қизил тугунча ёки тангачасимон, пўстлоқ билан қопланган зарарланиш кўринишида намоён бўлади. У ғадир-будур, қалинлашган доғ ёки сўгалли ўсиш шаклида бошланиши мумкин, бу вақт ўтиши билан сезиларли бўлади.",
                      "Ранги: Зарарланиш тана, пушти, қизил, жигарранг ёки кулранг тусда бўлиши мумкин, айниқса қуёшдан зарарланиш белгилари мавжуд бўлса.",
                      "Текстура: Юзаси тангачали, пўстлоқ билан қопланган ёки ярали бўлиши мумкин. Баъзан қонаши ёки оғриши мумкин.",
                      "Ўлчами: Ўсма ўлчами кичикдан бир неча сантиметргача бўлиши мумкин. Кўпинча тез ўсиш кузатилади.",
                    ],
                  },
                },
              ],
              ...
              elements: [
                {
                  ...
                  content: {
                    kr: [
                      "Қуёш нурлари таъсирида бўладиган жойлар: ЯҲК кўпинча юз, қулоқ, бўйин, бош териси, қўл, билак, елка, орқа ва лабларда учрайди. Одатда қуёш нури тушмайдиган жойларда, яъни жинсий аъзолар, оғиз бўшлиғи, шиллиқ қаватларда (айниқса, иммунитети заиф одамларда) ҳам учраши мумкин.",
                      "Сурункали яралар: ЯҲК сурункали яралар, куйиш чандиқлари ёки узоқ вақт таъсирланган ёки инфекцияланган тери қисмлари ўрнида ривожланиши мумкин.",
                    ],
                  },
                },
              ],
              ...
              elements: [
                {
                  ...
                  content: {
                    kr: [
                      "Ультрабинафша нурлар таъсири: Асосий хавф омили қуёш ёки солярийларнинг узоқ муддатли ва такрорий ультрабинафша нурлари таъсиридир.",
                      "Оч рангли тери: Оч рангли тери, оч ёки қизғиш сочлар ва кўк ёки яшил кўзли одамлар ЯҲК ривожланиш хавфига кўпроқ моил бўлади.",
                      "Ёши: Кўпинча кексаларда (50 ёшдан ошган) учрайди.",
                      "Иммуносупрессия: Иммун тизими заифлашган одамлар (масалан, орган кўчириб ўтказилгандан кейин ёки ОИВ/ОИТС билан касалланганда) юқори хавф остида бўлади.",
                      "Тери саратонининг олдинги ҳолатлари: Анамнезда базал ҳужайрали карцинома каби тери саратонининг бошқа турлари мавжудлиги ЯҲК ривожланиш хавфини оширади.",
                      "ОПВ инфекцияси: Одам папиллома вирусининг (ОПВ) баъзи штаммлари, айниқса шиллиқ қаватларда, ЯҲК хавфини оширади.",
                      "Сурункали тери касалликлари: Актиник кератоз каби саратон олди ҳолатлари ва куйиш ёки сурункали яллиғланишлардан ҳосил бўлган чандиқ тўқималар ҳам хавф омилларидир.",
                    ],
                  },
                },
              ],
              ...
              elements: [
                {
                  ...
                  content: {
                    kr: [
                      "Теридаги ўзгаришлар: Ўсиб бораётган, тангачали ёки пўстлоқ билан қопланган, битмайдиган тугунча. Қонаши ёки қичишиши мумкин.",
                      "Оғриқ ёки сезувчанлик: Ўсма ўсиши ёки яра ҳосил бўлиши билан оғриқ келтириб чиқариши мумкин.",
                      "Яра ҳосил бўлиши: Баъзан марказий кратерли ва четлари зичлашган яра ҳосил бўлади.",
                      "Шиш: Лимфа тугунларига тарқалганда, уларнинг катталашиши кузатилиши мумкин.",
                    ],
                  },
                },
              ],
              ...
              elements: [
                {
                  ...
                  content: {
                    kr: [
                      "Клиник текширув: Онкодерматолог шубҳали тузилмани текшириб, унинг тангачалилиги, зичлиги, нотекис чегаралари ва эҳтимолий қон кетишига эътибор қаратади.",
                      "Тери биопсияси: Ташхисни тасдиқлашнинг асосий усули микроскопик таҳлил учун тўқима намунасини олишдир.",
                      "Визуализатсия: Метастазларга шубҳа қилинганда КТ, МРТ ёки рентген текшируви талаб қилиниши мумкин.",
                    ],
                  },
                },
              ],
              ...
              elements: [
                {
                  ...
                  content: {
                    kr: [
                      "0-босқич (саратон in situ): Ўсма эпидермис билан чегараланган.",
                      "I-III босқичлар: Саратон терига чуқурроқ кириб боради ва лимфа тугунларига таъсир қилиши мумкин, аммо узоқ органларга тарқалмайди.",
                      "IV босқич: Узоқдаги аъзоларга (жигар, ўпка, суяк ва бошқалар) метастаз беради.",
                    ],
                  },
                },
              ],
              ...
              elements: [
                {
                  ...
                  content: {
                    kr: [
                      "Жарроҳлик йўли билан олиб ташлаш: Кенг кесиш — ўсмани атрофидаги соғлом тўқима билан олиб ташлаш.",
                      "Моос бўйича микрографик жарроҳлик: Касалликнинг қайталаниш хавфи юқори бўлган жойларда ёки косметик жиҳатдан аҳамиятли ҳудудларда қўлланилади.",
                      "Нур терапияси: Жарроҳлик йўли билан даволашнинг иложи бўлмаганда ёки операциядан кейин қолган саратон ҳужайраларини йўқ қилиш учун қўлланилади.",
                      "Криотерапия: ЯҲК нинг юзаки шакллари учун мос келади.",
                      "Маҳаллий даволаш: ЯҲК нинг юзаки шакллари учун кимётерапевтик ёки иммуномодулловчи малҳамлар (масалан, 5-фторуратсил ёки имиквимод) қўлланилиши мумкин.",
                      "Кимётерапия: Агар бошқа усулларни қўллашнинг иложи бўлмаса, ривожланган шаклларда қўлланилади.",
                      "Иммунотерапия: Назорат нуқталари ингибиторлари (масалан, пембролизумаб ёки ниволумаб) иммун тизимини ўсмани аниқлаш ва унга ҳужум қилишга ундайди.",
                    ],
                  },
                },
              ],
              ...
              elements: [
                {
                  ...
                  content: {
                    kr: [
                      "Касалликнинг оқибати ўсманинг катта-кичиклигига, чуқурлигига, олган жойига ва нечоғлик тарқалганига боғлиқ.",
                      "Эрта аниқланганда ва чегараланган шаклида прогноз ижобий.",
                      "Метастазларда яшовчанлик сезиларли даражада пасаяди.",
                    ],
                  },
                },
              ],
              ...
              elements: [
                {
                  ...
                  content: {
                    kr: [
                      "Қуёшдан ҳимояланиш: Қуёшдан ҳимояловчи крем (SPF 30+), ҳимоя кийимларидан фойдаланиш, тиғиз пайтларда қуёшдан сақланиш.",
                      "Солярийлардан воз кечиш: ЯҲК ва тери саратонининг бошқа турлари ривожланиш хавфини камайтиради.",
                      "Мунтазам текширувлар: Терини ўз-ўзини текшириш ва онкодерматологга ташриф буюриш хавф юқори бўлган одамлар учун айниқса муҳимдир.",
                    ],
                  },
                },
              ],
              ...
              elements: [
                {
                  ...
                  content: {
                    uz: [
                      "Yangi hosilalar tavsifi: YAHS odatda zich qizil tuguncha yoki tangachasimon, po‘stloq bilan qoplangan zararlanish ko‘rinishida namoyon bo‘ladi. U g‘adir-budur, qalinlashgan dog‘ yoki so‘galli o‘sish shaklida boshlanishi mumkin, bu vaqt o‘tishi bilan sezilarli bo‘ladi.",
                      "Rangi: Zararlanish tana, pushti, qizil, jigarrang yoki kulrang tusda bo‘lishi mumkin, ayniqsa quyoshdan zararlanish belgilari mavjud bo‘lsa.",
                      "Tekstura: Yuzasi tangachali, po‘stloq bilan qoplangan yoki yarali bo‘lishi mumkin. Ba'zan qonashi yoki og‘rishi mumkin.",
                      "O‘lchami: O‘sma o‘lchami kichikdan bir necha santimetrgacha bo‘lishi mumkin. Ko‘pincha tez o‘sish kuzatiladi.",
                    ],
                  },
                },
              ],
              ...
              elements: [
                {
                  ...
                  content: {
                    uz: [
                      "Quyosh nurlari ta'sirida bo‘ladigan joylar: YAHS ko‘pincha yuz, quloq, bo‘yin, bosh terisi, qo‘l, bilak, yelka, orqa va lablarda uchraydi. Odatda quyosh nuri tushmaydigan joylarda, ya'ni jinsiy a'zolar, og‘iz bo‘shlig‘i, shilliq qavatlarda (ayniqsa, immuniteti zaif odamlarda) ham uchrashi mumkin.",
                      "Surunkali yaralar: YAHS surunkali yaralar, kuyish chandiqlari yoki uzoq vaqt ta'sirlangan yoki infeksiyalangan teri qismlari o‘rnida rivojlanishi mumkin.",
                    ],
                  },
                },
              ],
              ...
              elements: [
                {
                  ...
                  content: {
                    uz: [
                      "Ultrabinafsha nurlar ta'siri: Asosiy xavf omili quyosh yoki solyariylarning uzoq muddatli va takroriy ultrabinafsha nurlari ta'siridir.",
                      "Och rangli teri: Och rangli teri, och yoki qizg‘ish sochlar va ko‘k yoki yashil ko‘zli odamlar YAHS rivojlanish xavfiga ko‘proq moyil bo‘ladi.",
                      "Yoshi: Ko‘pincha keksa odamlarda (50 yoshdan oshgan) uchraydi.",
                      "Immunosupressiya: Immun tizimi zaiflashgan odamlar (masalan, organ ko‘chirib o‘tkazilgandan keyin yoki OIV/OITS bilan kasallanganda) yuqori xavf ostida bo‘ladi.",
                      "Teri saratonining oldingi holatlari: Anamnezda bazal hujayrali karsinoma kabi teri saratonining boshqa turlari mavjudligi YAHS rivojlanish xavfini oshiradi.",
                      "OPV infeksiyasi: Odam papilloma virusining (OPV) ba'zi shtammlari, ayniqsa shilliq qavatlarda, YAHS xavfini oshiradi.",
                      "Surunkali teri kasalliklari: Aktinik keratoz kabi saraton oldi holatlari va kuyish yoki surunkali yallig‘lanishlardan hosil bo‘lgan chandiq to‘qimalar ham xavf omillaridir.",
                    ],
                  },
                },
              ],
              ...
              elements: [
                {
                  ...
                  content: {
                    uz: [
                      "Teridagi o‘zgarishlar: O‘sib borayotgan, tangachasimon yoki po‘stloq bilan qoplangan, bitmaydigan tuguncha. Qonashi yoki qichishishi mumkin.",
                      "Og‘riq yoki sezuvchanlik: O‘sma o‘sishi yoki yara hosil bo‘lishi bilan og‘riq keltirib chiqarishi mumkin.",
                      "Yara hosil bo‘lishi: Ba'zan markaziy kraterli va chetlari zichlashgan yara hosil bo‘ladi.",
                      "Shish: Limfa tugunlariga tarqalganda, ularning kattalashishi kuzatilishi mumkin.",
                    ],
                  },
                },
              ],
              ...
              elements: [
                {
                  ...
                  content: {
                    uz: [
                      "Klinik tekshiruv: Onkodermatolog shubhali tuzilmani tekshirib, uning tangachasimonligi, zichligi, notekis chegaralari va ehtimoliy qon ketishiga e'tibor qaratadi.",
                      "Teri biopsiyasi: Tashxisni tasdiqlashning asosiy usuli mikroskopik tahlil uchun to‘qima namunasini olishdir.",
                      "Vizualizatsiya: Metastazlarga shubha qilinganda KT, MRT yoki rentgen tekshiruvi talab qilinishi mumkin.",
                    ],
                  },
                },
              ],
              ...
              elements: [
                {
                  ...
                  content: {
                    uz: [
                      "0-bosqich (saraton in situ): O‘sma epidermis bilan chegaralangan.",
                      "I-III bosqichlar: Saraton teriga chuqurroq kirib boradi va limfa tugunlariga ta'sir qilishi mumkin, ammo uzoq organlarga tarqalmaydi.",
                      "IV bosqich: Uzoqdagi a'zolarga (jigar, o‘pka, suyak va boshqalar) metastaz beradi.",
                    ],
                  },
                },
              ],
              ...
              elements: [
                {
                  ...
                  content: {
                    uz: [
                      "Jarrohlik yo‘li bilan olib tashlash: Keng kesish — o‘smalarni atrofidagi sog‘lom to‘qima bilan olib tashlash.",
                      "Moos bo‘yicha mikrografik jarrohlik: Kasallikning qaytalanish xavfi yuqori bo‘lgan joylarda yoki kosmetik jihatdan ahamiyatli hududlarda qo‘llaniladi.",
                      "Nurlanish terapiyasi: Jarrohlik yo‘li bilan davolashning iloji bo‘lmaganda yoki operatsiyadan keyin qolgan saraton hujayralarini yo‘q qilish uchun qo‘llaniladi.",
                      "Krioterapiya: YAHS ning yuzaki shakllari uchun mos keladi.",
                      "Mahalliy davolash: YAHS ning yuzaki shakllari uchun kimyoterapevtik yoki immunomodullovchi malhamlar (masalan, 5-fluoruratsil yoki imikvimod) qo‘llanilishi mumkin.",
                      "Kimyoterapiya: Agar boshqa usullarni qo‘llashning iloji bo‘lmasa, rivojlangan shakllarda qo‘llaniladi.",
                      "Immunoterapiya: Nazorat nuqtalari ingibitorlari (masalan, pembrolizumab yoki nivolumab) immun tizimini o‘smalarni aniqlash va ularga hujum qilishga undaydi.",
                    ],
                  },
                },
              ],
              ...
              elements: [
                {
                  ...
                  content: {
                    uz: [
                      "Kasallikning oqibati o‘smalarning katta-kichikligiga, chuqurligiga, olgan joyiga va nechog‘lik tarqalganiga bog‘liq.",
                      "Erta aniqlanganda va chegaralangan shaklida prognoz ijobiy.",
                      "Metastazlarda yashovchanlik sezilarli darajada pasayadi.",
                    ],
                  },
                },
              ],
              ...
              elements: [
                {
                  ...
                  content: {
                    uz: [
                      "Quyoshdan himoyalanish: Quyoshdan himoyalovchi krem (SPF 30+), himoya kiyimlaridan foydalanish, tig‘iz paytlarda quyoshdan saqlanish.",
                      "Solyarilardan voz kechish: YAHS va teri saratonining boshqa turlari rivojlanish xavfini kamaytiradi.",
                      "Muntazam tekshiruvlar: Terini o‘z-o‘zini tekshirish va onkodermatologga tashrif buyurish xavfi yuqori bo‘lgan odamlar uchun ayniqsa muhimdir.",
                    ],
                  },
                },
              ],
